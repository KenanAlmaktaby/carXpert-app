...
import 'package:carxpert/ui/style/widgets/costume_list.dart';
...
class SaleCarsPage extends StatelessWidget {
  ...
  List<CarModel> cars = [
    CarModel(
        ...
        mileage: 120,
        colors: [
          ColorModel(name: Color(0xffc01111), quantity: 2),
          ColorModel(name: Color(0xff2b1894), quantity: 1),
          ColorModel(name: Color(0xff554aa9), quantity: 1),
          ColorModel(name: Color(0xffdac136), quantity: 2)
        ],
        ...
        child: Column(
          children: [
            HeaderWithIcons(
              title: 'Cars for Sale',
              searchFunction: () {
                Get.toNamed('/SaleSearch');
              },
              isAccessory: false,
            ),
            Expanded(
              child: Obx(
                () => saleCarsController.isLoading.value
                    ? Center(
